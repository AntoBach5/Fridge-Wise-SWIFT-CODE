...
enum SampleData {
    ...
    static let detectableIngredients: [Ingredient] = [
        ...
        Ingredient(name: "Espinaca", category: .produce, quantity: "1 atado", expiresAt: days(2)),
        ...
        Ingredient(name: "Fideos integrales", category: .grains, quantity: "500 g", expiresAt: days(180)),
        ...
        Ingredient(name: "Manteca", category: .dairy, quantity: "200 g", expiresAt: days(35)),
        ...
        Ingredient(name: "Arvejas congeladas", category: .frozen, quantity: "400 g", expiresAt: days(120)),
    ...
    static let recipes: [Recipe] = [
        Recipe(
            ...
            ingredients: [
                ...
                RecipeIngredient(name: "Espinaca", amount: "1 atado", category: .produce, isInPantry: true),
            ...
            steps: [
                RecipeStep(order: 1, instruction: "Calentá el horno a 180 °C. Salteá la cebolla en aceite de oliva hasta que esté translúcida.", minutes: 5),
                RecipeStep(order: 2, instruction: "Sumá la espinaca y cociná hasta que pierda el agua. Escurrí bien.", minutes: 4,
                           tip: "Si queda agua, la frittata sale húmeda por dentro."),
                RecipeStep(order: 3, instruction: "Batí los huevos con la mitad del parmesano, sal y pimienta. Mezclá con la verdura.", minutes: 3),
                RecipeStep(order: 4, instruction: "Volcá en una sartén de hierro y cociná a fuego bajo 4 minutos, hasta que los bordes cuajen.", minutes: 4),
                RecipeStep(order: 5, instruction: "Terminá en el horno 6 minutos con el resto del parmesano encima.", minutes: 6,
        ...
        Recipe(
            ...
            steps: [
                RecipeStep(order: 1, instruction: "Salpimentá el pollo y sellalo 4 minutos de cada lado. Reservalo.", minutes: 8),
                RecipeStep(order: 2, instruction: "En la misma sartén, dorá el ajo y sumá el arroz. Nacaralo un minuto.", minutes: 3),
                RecipeStep(order: 3, instruction: "Agregá el caldo, el jugo de un limón y la mostaza. Llevá a hervor.", minutes: 3),
                RecipeStep(order: 4, instruction: "Volvé el pollo a la sartén, tapá y cociná a fuego bajo 18 minutos.", minutes: 18,
                           tip: "No destapes: el arroz integral necesita el vapor."),
                RecipeStep(order: 5, instruction: "Reposá 3 minutos y terminá con ralladura de limón y perejil.", minutes: 3)
            ],
        ...
        Recipe(
            ...
            subtitle: "Liviana, económica y aguanta dos días",
            source: .editorial,
            ...
            steps: [
                RecipeStep(order: 1, instruction: "Horno a 200 °C. Cortá las zanahorias en bastones gruesos.", minutes: 4),
                RecipeStep(order: 2, instruction: "Mezclá zanahorias y garbanzos escurridos con aceite, comino y sal. Asá 20 minutos.", minutes: 20,
                           tip: "Secá bien los garbanzos con papel: así quedan crocantes en vez de blandos."),
                RecipeStep(order: 3, instruction: "Batí el yogur con jugo de limón y sal para el aderezo.", minutes: 2),
                RecipeStep(order: 4, instruction: "Serví tibio, con el aderezo por encima y menta si tenés.", minutes: 2)
            ],
        ...
        Recipe(
            title: "Salmón con arvejas a la manteca",
            ...
            ingredients: [
                ...
                RecipeIngredient(name: "Arvejas congeladas", amount: "300 g", category: .frozen, isInPantry: true),
                RecipeIngredient(name: "Manteca", amount: "40 g", category: .dairy, isInPantry: true),
                RecipeIngredient(name: "Limón", amount: "1", category: .produce, isInPantry: true),
                RecipeIngredient(name: "Eneldo", amount: "1 puñado", category: .produce, isInPantry: false, isOptional: true)
            ],
            steps: [
                RecipeStep(order: 1, instruction: "Descongelá el salmón en la heladera o bajo agua fría corriente. Secalo bien.", minutes: 5,
                           tip: "Nunca lo descongeles a temperatura ambiente."),
                RecipeStep(order: 2, instruction: "Sellá el salmón con la piel hacia abajo 5 minutos sin moverlo.", minutes: 5),
                RecipeStep(order: 3, instruction: "Dalo vuelta 2 minutos y reservá. Salteá las arvejas en la manteca.", minutes: 5),
                RecipeStep(order: 4, instruction: "Terminá con jugo de limón y serví el salmón sobre las arvejas.", minutes: 3)
            ],
        ...
        Recipe(
            ...
            subtitle: "Reconfortante sin crema, sólo con el almidón",
            source: .community,
            minutes: 25, difficulty: 1, calories: 560, servings: 2,
            grade: .c,
            macros: Macros(proteinGrams: 18, carbGrams: 78, fatGrams: 18, fiberGrams: 7),
            ingredients: [
                RecipeIngredient(name: "Fideos integrales", amount: "220 g", category: .grains, isInPantry: true),
            ...
            steps: [
                RecipeStep(order: 1, instruction: "Poné a hervir agua con bastante sal y cociná los fideos.", minutes: 10),
                RecipeStep(order: 2, instruction: "Mientras, reventá los tomates en una sartén con ajo y aceite.", minutes: 8),
                RecipeStep(order: 3, instruction: "Sumá un cucharón del agua de cocción y el parmesano fuera del fuego.", minutes: 3,
                           tip: "El almidón del agua es lo que emulsiona: sin eso la salsa se corta."),
                RecipeStep(order: 4, instruction: "Mezclá los fideos con la salsa y terminá con albahaca.", minutes: 2)
            ],
    ...
    static func reviews(for recipeID: Recipe.ID) -> [Review] {
        [
            ...
            Review(recipeID: recipeID, author: authors[2], rating: 4,
                   body: "Muy buena base. Le sumé morrón asado y un poco de ricota, y rindió para tres.",
                   createdAt: days(-5), helpfulCount: 11,
                   variationNote: "Con morrón y ricota"),
    ...
    static var listItems: [ListItem] {
        [
            ...
            ListItem(kind: .toBuy, title: "Perejil", detail: "1 atado", category: .produce,
    ...
    static let rewards: [Reward] = [
        ...
        Reward(kind: .extraGenerations,
               ...
               detail: String(localized: "Generaciones adicionales para cuando querés explorar."),
        ...
        Reward(kind: .premiumTrial,
               ...
               detail: String(localized: "Probá todo sin límites una semana. No se renueva ni pide tarjeta."),
    ...
    static var pointsHistory: [PointsEntry] {
        [
            ...
            PointsEntry(event: .recipeCooked, amount: 25, date: days(-4),
                        note: "Salmón con arvejas a la manteca"),
